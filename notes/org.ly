...
AgnusOrgano = {
  \relative c {
    ...
    \mvTr c8\pE-\solo es d g
    c, es d g
    c, es f g
    c,[ r16. \parOn g'32]\f-\parenthesize-! c16.-! g32-! es16.-! \parOff c32-\parenthesize-!
    f8\p f b, b %5
    es es as, as
    d d g, g
    c g g' f
    \slurDashed es16(-. es-. es-. es-.) es(-. es-. es-. es-.)
    f(-. f-. f-. f-.) f(-. f-. f-. f-.) %10
    g(-. g-. g-. g-.) g(-. g-. g-. g-.)
    as8 as16 g as8 f
    es es d g,
    ...
    a,!( c es ges) a!( c es) a,,
    b b b b b b b b
    es8 g16.-!-\solo b32-! es16.-! b32-! g16.-! es32-! %25
    as8\p as d, d
    g g c, c
    f f b, d
    es b b' as
    g16 g g g g g g g %30
    as as as as b b b b
    es,8 es f g
    as f b b,
    \mvTr es\fE-\tutti es es es
    b' b, r b %35
    es es r es
    a,! a a a
    b4 \mvTr b'8\f-\tutti b
    as4 g!8 f
    es es es es %40
    f f fis fis
    g g g, g
    \mvTr c\p-\solo es d g
    c, es d g
    c, es f g %45
    c,4 \mvTr c8\fE-\tutti c
    a! a h g
    c c c c'
    as as as g
    fis fis fis fis %50
    g4 g,
    \slurDashed \mvTr es'16(-.\p-\solo es-. es-. es-.) es(-. es-. es-. es-.)
    f(-. f-. f-. f-.) f(-. f-. f-. f-.)
    g(-. g-. g-. g-.) g(-. g-. g-. g-.)
    as8 as16 g as8 f %55
    es es d g,
...
AgnusBassFigures = \figuremode {
  ...
  r
  \bo <6 5 [_-]>4 \bc <7 5 [_!]>
  \bo <[6] 4>8 \bc <[5] _!>4. %20
  <4! _->4 <\t [2]>
  <6>2
  <7- 5>4 \bassFigureExtendersOn q8. q16 \bassFigureExtendersOff
  <5 4>4 <\t 3>
  <[_!]>2 %25
  r4 <7 [5-]>
  r <7>
